...
/*
CADMesh * mesh = new CADMesh("beamlines.", mm, G4ThreeVector(0, 0, 0), false);
...
*/
  ...
  CADMesh * vol01_mesh = new CADMesh("/bodycut.stl", mm, G4ThreeVector(0, 0, 0), false);
  ...
  CADMesh * vol02_mesh = new CADMesh("/body.stl", mm, G4ThreeVector(0, 0, 0), false);
  ...
  CADMesh * vol03_mesh = new CADMesh("/IP_NEG_CHAMBER_E-US_FLANGE.stl", mm, G4ThreeVector(0, 0, 0), false);
  ...
  CADMesh * vol04_mesh = new CADMesh("/IR_CHAMBER_CENTRAL_TUBE.stl", mm, G4ThreeVector(0, 0, 0), false);
  ...
  CADMesh * vol05_mesh = new CADMesh("/IR_CHAMBER_ELECTRON_MASK.stl", mm, G4ThreeVector(0, 0, 0), false);
  ...
  CADMesh * vol06_mesh = new CADMesh("/IR_CHAMBER_WATERSPACE.stl", mm, G4ThreeVector(0, 0, 0), false);
  ...
  CADMesh * vol07_mesh = new CADMesh("/IR_CENTRAL_CHAMBER_GOLD_COAT.stl", mm, G4ThreeVector(0, 0, 0), false);
  ...
  CADMesh * vol13_mesh = new CADMesh("/IP_WATER_TUBE.stl", mm, G4ThreeVector(0, 0, 0), false);
  ...
  CADMesh * vol14_mesh = new CADMesh("/IP_WATER_TUBE_END1.stl", mm, G4ThreeVector(0, 0, 0), false);
  ...
  CADMesh * vol15_mesh = new CADMesh("/IP_WATER_TUBE_END2.stl", mm, G4ThreeVector(0, 0, 0), false);
  ...
  CADMesh * vol16_mesh = new CADMesh("/JL0081018.stl", mm, G4ThreeVector(0, 0, 0), false);
