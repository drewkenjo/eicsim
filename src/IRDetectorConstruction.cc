...
class cb_VTX_Design {
public:
//    Edited to match definition of "World" and world_mat
    inline void Construct(cb_VTX_Config cfg, world_mat, "World") {
        ...
        Logic = new G4LogicalVolume(Solid, world_mat, "cb_VTX_GVol_Logic");
 ...
 inline void ConstructLadders() {
        ...
        // Removed dependency on JLeicMaterials.hh
 ...
 std::vector <cb_VTX_ladder_LayParam> Lays;
        ...
        // Lay 0
        Lay.Dx=0.100 * mm; Lay.Dy=2*cm; Lay.Dz=10*cm; Lay.Rin=3.5 * cm; Lays.push_back(Lay);
        // Lay 1
        Lay.Dx=0.100 * mm; Lay.Dy=2*cm; Lay.Dz=11*cm; Lay.Rin=4.5 * cm; Lays.push_back(Lay);
        // Lay 2
        Lay.Dx=0.100 * mm; Lay.Dy=4*cm; Lay.Dz=18*cm; Lay.Rin=6.5 * cm; Lays.push_back(Lay);
        // Lay 3
        Lay.Dx=0.100 * mm; Lay.Dy=4*cm; Lay.Dz=24*cm; Lay.Rin=10.5 * cm; Lays.push_back(Lay);
        // Lay 4
        Lay.Dx=0.100 * mm; Lay.Dy=4*cm; Lay.Dz=36*cm; Lay.Rin=13.5 * cm; Lays.push_back(Lay);
        // Lay 5
        Lay.Dx=0.100 * mm; Lay.Dy=4*cm; Lay.Dz=48*cm; Lay.Rin=15.5 * cm; Lays.push_back(Lay);
...
//I don't know how to handle lines 384-397, whether they are correct or need to be edited, etc.
private:
    JLeicMaterials *fMat;
