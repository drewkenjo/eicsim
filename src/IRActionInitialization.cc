...
//
//
/// \file IRActionInitialization.cc
/// \brief Implementation of the IRActionInitialization class
...
{
  IRRunAction* runAction = new IRRunAction;
...
void IRActionInitialization::Build() const
{
  ...
  IREventAction* eventAction = new IREventAction(runAction);
  SetUserAction(eventAction);
  
  SetUserAction(new IRSteppingAction(eventAction));
}  
